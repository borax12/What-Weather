...
public class WeatherFragment extends Fragment {
	...
	private void renderWeather(JSONObject json)
	{
		try
		{
			...
			detailsField.setText(details.getString("description").toUpperCase(Locale.US)+"\n"+"Humidity:"+main.getString("humidity")+"%"+"Pressure:"+main.getString("pressure")+"hPa");
			...
			updateField.setText("Last update on:"+updatedOn);
			
			setWeatherIcon(details.getInt("id"),json.getJSONObject("sys").getLong("sunrise")*1000,json.getJSONObject("sys").getLong("sunrise")*1000);
			
		}
		catch(Exception e)
		{
			Log.e("WhatWeather", "One or more fields not found in the JSON Data");
		}
	}
